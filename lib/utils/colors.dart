...
class DarkColors {
  ...
  static const btnBgColor = Color.fromARGB(255, 33, 35, 40);
...
class LightColors {
  ...
  static const sheetBgColor = Color.fromARGB(255, 240, 237, 237);
  static const btnBgColor = Color.fromARGB(255, 213, 213, 213);
